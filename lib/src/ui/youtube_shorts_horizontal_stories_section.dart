...
import 'package:youtube_shorts/src/ui/youtube_shorts_page.dart';

import '../data/not_focused_ui_type.dart';
import '../data/type_defs.dart';
import '../logic/shorts_controller.dart';
import '../logic/shorts_state.dart';
import 'elements/condition_to_update_value_listenable.dart';
import 'elements/default_widgets.dart';
                                              ...
                                              builder: (context) {
                                                ...
                                                return Image.network(
                                                  switch (tumbnail.quality) {
                                                    TumbnailQuality.lowResUrl =>
                                                      dataTumbnail.lowResUrl,
                                                    TumbnailQuality
                                                          .mediumResUrl =>
                                                      dataTumbnail.mediumResUrl,
                                                    TumbnailQuality
                                                          .standardResUrl =>
                                                      dataTumbnail
                                                          .standardResUrl,
